...
Trigger condition:
Used in Stage 4 to generate initial candidate programs for the `transition` component.

Major inputs:
- base proposal prompt text
- execution_rules.md
- transition_program_spec.md
