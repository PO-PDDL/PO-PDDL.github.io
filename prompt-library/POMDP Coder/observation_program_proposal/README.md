...
Trigger condition:
Used in Stage 4 to generate initial candidate programs for the `observation` component.

Major inputs:
- base proposal prompt text
- execution_rules.md
- observation_program_spec.md
...
- must define `sample_observation`
